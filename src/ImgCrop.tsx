import type { ModalProps } from 'sryd';
import AntModal from 'sryd/es/modal';
import AntUpload from 'sryd/es/upload';
import type { RcFile, UploadFile } from 'sryd/es/upload/interface';
